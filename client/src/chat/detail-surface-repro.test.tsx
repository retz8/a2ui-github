      ...
      components: [
        {
          id: 'body-author',
          component: 'Text',
          text: {path: '/pull_request/user/login'},
          weight: 'semibold',
        },
        {id: 'body-av', component: 'TimelineAvatar', child: 'body-avatar'},
        {
          ...
          alt: {path: '/pull_request/user/login'},
          size: 24,
        },
        ...
        {id: 'body-content', component: 'TimelineBody', children: ['body-head', 'body-p1']},
        {
          ...
          gap: 'condensed',
          align: 'center',
          children: ['body-author', 'body-verb', 'body-time'],
        },
        {id: 'body-icon', component: 'Icon', name: 'git-pull-request'},
        {
          id: 'body-item',
          component: 'TimelineItem',
          children: ['body-av', 'body-badge', 'body-content'],
        },
        {id: 'body-p1', component: 'Text', text: {path: '/pull_request/body'}, as: 'p'},
        {
          id: 'body-time',
          component: 'RelativeTime',
          datetime: {path: '/pull_request/created_at'},
          format: 'relative',
        },
        ...
        },
        {
          ...
          children: {componentId: 'label-token', path: '/pull_request/labels'},
        },
        {id: 'labels-head', component: 'Heading', text: 'Labels', as: 'h3', variant: 'small'},
        {
          ...
          direction: 'vertical',
          gap: 'normal',
          children: ['reviewers-head', 'reviewers-list', 'labels-head', 'labels-group'],
        },
        {
          id: 'ph',
          component: 'PageHeader',
          'aria-label': 'Pull request header',
          children: ['ph-ta', 'ph-desc'],
        },
        ...
        {id: 'ph-lv', component: 'PageHeader.LeadingVisual', children: ['ph-icon']},
        {
          ...
          status: 'pullOpened',
          text: {path: '/pull_request/state_label_text'},
        },
        {
          id: 'ph-ta',
          component: 'PageHeader.TitleArea',
          variant: 'large',
          children: ['ph-lv', 'ph-title'],
        },
        {
          id: 'ph-title',
          component: 'PageHeader.Title',
          text: {path: '/pull_request/title_with_number'},
          as: 'h1',
        },
        {
          id: 'pn',
          component: 'PageLayout.Pane',
          position: 'end',
          width: 'small',
          divider: 'line',
          children: ['meta'],
        ...
        },
        {
          ...
          gap: 'condensed',
          align: 'center',
          children: ['reviewer-avatar', 'reviewer-name'],
        },
        {id: 'reviewers-head', component: 'Heading', text: 'Reviewers', as: 'h3', variant: 'small'},
        {
          ...
          direction: 'vertical',
          gap: 'condensed',
          children: {componentId: 'reviewer-row', path: '/pull_request/requested_reviewers'},
        },
        {
          id: 'root',
