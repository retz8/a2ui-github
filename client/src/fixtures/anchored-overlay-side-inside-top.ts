...
// side placement: inside-top.
export const anchoredOverlaySideInsideTopFixture: Fixture = {
  name: 'anchored-overlay-side-inside-top',
  messages: [
    {
      version: 'v0.9',
      createSurface: {surfaceId: 'anchored-overlay-side-inside-top', catalogId: CATALOG_ID},
    },
    {
      version: 'v0.9',
      updateComponents: {
        surfaceId: 'anchored-overlay-side-inside-top',
        components: [
          {
            id: 'root',
