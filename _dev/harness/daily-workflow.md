...
- **All of `_dev/` lives on `main`** — `TODO.md`, `docs/spec/`, `docs/plan/`, `docs/handoff/`, `harness/` are edited and committed on `main` only.
...
`pick-up-task` (dispatcher), `wrap-up`, `rebase-with-main`, plus `grill-me` / `grill-to-spec`.

## Deferred — set up during Phase 3

The autonomous layer: nightly Claude routine, GitHub issues / milestones / labels, Monday review window, versioning, release ritual.
