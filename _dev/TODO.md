...
- [WIP] **7.7** Beat-by-beat verification and refinement — drive each beat through the live stack, iterating on the 7.1 artifacts until beats pass; demand-driven local functions grow here (beat 5 proves the mechanism). Phase definition-of-done.
