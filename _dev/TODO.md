...
- [WIP] **8.1** Beat fixture recording — run each of the 8 beats live once and persist the streams as replay fixtures; includes the beats-2/6 model-knob retry and re-grade.
