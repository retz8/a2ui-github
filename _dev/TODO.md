...
- [ ] **7.8** Examples showcase page — a permanent client page, alongside home + dev, that renders the 7.1 knowledge examples through the existing A2UI render pipeline; visual verification of the curated fixtures. (#111)
