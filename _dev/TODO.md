...
- [WIP] **8.0** Phase-spec understanding & refinement session — user-driven deep-read of the phase spec (paradigm, glossary, storage decisions), refining where wanted; this sub-task may amend the phase spec.
