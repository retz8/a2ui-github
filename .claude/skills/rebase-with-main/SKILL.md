...
See [`_dev/harness/daily-workflow.md`](../../../_dev/harness/daily-workflow.md) for how this fits the daily loop. Sub-task work happens in worktrees off `main` (`phase-<N>/<M>-<kebab>`); this skill keeps the active branch current.
